...
const SEED = [
  {
    ...
    description:"Uses GPT-4o to score & rank backlog items by effort, impact and strategic alignment.",
    status:"released", type:"integrated", owner:"Priya Sharma",
    clients:["Acme Corp","NovaTech","BlueWave"],
    impact:"High", effort:"Medium", releaseDate:"2026-04-15", lastUpdated:"2026-05-01",
    notes:"Refresh cadence: 24h",
    snapshot:{
      ...
      clientFeedback:{ sentiment:"Positive", quote:"Cut our sprint planning from 3 hours to 45 minutes. Game changer.", client:"Acme Corp" },
    },
  },
  {
    id:"cap-002", title:"Meeting → Action Items",
    description:"Transcribes meetings via Whisper API and extracts structured action items with owners.",
    status:"in_progress", type:"poc", owner:"Daniel Osei",
    clients:["SkyBridge","Meridian Health"],
    impact:"High", effort:"High", releaseDate:"2026-06-01", lastUpdated:"2026-05-10",
    notes:"Blocked: privacy review",
    snapshot:{
      ...
      clientFeedback:{ sentiment:"Positive", quote:"Transcription accuracy is impressive. Just need the privacy approvals sorted.", client:"SkyBridge" },
    },
  },
  {
    id:"cap-003", title:"PRD Auto-Generator",
    description:"Converts rough ideas into structured PRDs — goals, user stories, acceptance criteria.",
    status:"upcoming", type:"mvp", owner:"Leila Nazari",
    clients:["Internal"],
    impact:"Medium", effort:"Low", releaseDate:"2026-07-10", lastUpdated:"2026-05-08",
    notes:"Targeting Notion + GDocs output",
    snapshot:{
      ...
      clientFeedback:{ sentiment:"Needs Work", quote:"Output still needs significant manual editing before it's usable.", client:"Internal Team" },
    },
  },
  {
    id:"cap-004", title:"User Feedback Synthesizer",
    description:"Clusters NPS, surveys and tickets into weekly insight reports via automated digest.",
    status:"released", type:"integrated", owner:"Priya Sharma",
    clients:["Acme Corp","Pinnacle Group","Vertex Industries"],
    impact:"High", effort:"High", releaseDate:"2026-03-28", lastUpdated:"2026-05-01",
    notes:"K-means clustering model",
    snapshot:{
      ...
      clientFeedback:{ sentiment:"Positive", quote:"We've completely replaced our manual weekly feedback review. Saves 5 hours every week.", client:"Pinnacle Group" },
    },
  },
  {
    id:"cap-005", title:"Competitive Intelligence Bot",
    description:"Monitors competitor sites and press releases for weekly competitive signals.",
    status:"discovery", type:"research", owner:"Marcus Johansson",
    clients:["Internal"],
    impact:"Medium", effort:"High", releaseDate:"2026-08-30", lastUpdated:"2026-05-05",
    notes:"Build vs buy TBD",
    snapshot:{
      ...
      clientFeedback:{ sentiment:"Neutral", quote:"Interested in the concept but need to see a working prototype first.", client:"Internal — VP Strategy" },
    },
  },
  {
    id:"cap-006", title:"Stakeholder Update Generator",
    description:"Generates exec, engineering, and client updates from raw Jira sprint data.",
    status:"in_progress", type:"poc", owner:"Daniel Osei",
    clients:["SkyBridge","Acme Corp"],
    impact:"Medium", effort:"Low", releaseDate:"2026-05-30", lastUpdated:"2026-05-12",
    notes:"3 audience modes",
    snapshot:{
